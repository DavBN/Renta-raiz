    ...
    return (
        <main className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-[70%,1fr] my-3 py-5">
                <div className="px-6">
                    <h1 className="text-3xl mb-4 text-orange-400 flex justify-between">
                    ...
                    <div className="flex gap-5 my-4">
                        ...
                        <div className="flex items-center px-2 py-1 rounded-lg bg-orange-400 top-2 right-2 text-white">
                            <LiaStarSolid />
                            <span className="ml-1 font-semibold">{house.star}</span>
                        </div>
                    </div>
                    <Image src={`/assets/properties/${house.image}`}
                        alt={`Vivienda ubicada en ${house.location}`}
                        width={1200}
                        height={1200}
                        className="w-full h-auto rounded-2xl"
                        priority />
                    <div className="gap-4 lg:flex mt-4">
                        <div className="flex items-center justify-center px-2 py-1 my-1 rounded-lg bg-orange-300/30">
                            <LiaBedSolid />
