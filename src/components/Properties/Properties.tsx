        ...
        <Transition className="px-4 my-8 md:py-32 md:px-40">
                        ...
                        <div className="relative -z-[1]">
                            <div className="relative">
                                ...
                                <Image src={`/assets/properties/${image}`} alt="Location" width="150" height="150"
                                    className="object-cover w-full max-h h-[200px] rounded-t-2xl" />
                                <div className="px-3 py-5">
                                    <p className="text-orange-400">{location}</p>
                                    <p className="font-semibold">{formatPrice(price)}</p>
                                    <div className="gap-4 mt-2 xl:flex">
                                        <div className="flex items-center justify-center px-2 rounded-lg my-2 bg-orange-300/30">
                                            <LiaBedSolid />
            ...
            <div className="text-center py-7">
                {counterHouses < dataProperties.length && (
                    <button className="px-6 py-6 text-white transition-all duration-150 cursor-pointer bg-orange-400 rounded-xl hover:bg-black"
